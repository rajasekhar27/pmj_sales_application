...
export default function BestSellerProducts() {
  const bestseller = "bestseller-product";
  ...
  const { data: catalogueProducts } = useGetLimitBestSellerProductsQuery(
    {
        ...
        <div className="flex justify-between items-center  ">
          ...
          <div>
            <button
              onClick={() =>
                router.push(
                  `/catalogue/product-listing/${router?.query?.id}/${bestseller}`
                )
              }
